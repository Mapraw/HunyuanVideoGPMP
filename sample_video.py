...
def main():
    ...
    models_root_path = "ckpts/hunyuan-video-t2v-720p/transformers/hunyuan_video_720_quanto_int8.safetensors"
    ...
    offload.profile(pipe, profile_no= profile_type.LowRAM_LowVRAM)    
